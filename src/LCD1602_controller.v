...
// Mantenemos la lógica y los 5 estados
...
// =========================================================================
// EL DECODIFICADOR 
// Convierte el valor binario de los switches a código ASCII (0-7)
// =========================================================================
wire [7:0] decodificador_L1;
wire [7:0] decodificador_L2;
    ...
    if (reset == 0) begin
        ...
        case (next_state)
            ...
            WR_STATIC_TEXT_1L: begin
                ...
                // =========================================================
                //CAMBIAR LA MEMORIA (MULTIPLEXOR) LÍNEA 1
                // =========================================================
                if (data_counter == 4'd12) begin
                    data <= decodificador_L1;
                end else begin
